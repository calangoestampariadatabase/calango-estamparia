const Card = () => {
  ...
  return (
    <div className="py-[50px] md:py-[160px] lg:py-[200px] px-[15px] md:px-[40px] lg:px-[65px] relative">
  
<img className="absolute  h-20 top-[-50] md:h-50 left-5 " src="/assets/coroa.png" alt="" />
<img className="absolute md:h-auto h-15 bottom-[-40] right-10" src="/assets/coracao.png" alt="" />
